...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/wordlist"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif wordlist ; git clone https://github.com/moayad-star/wordlist.git")
